...
#             (117, timeNow.replace( day=7, month=7, hour=07, minute=0)), 
#             (117, timeNow.replace( day=8, month=7, hour=8, minute=0)), 
#                
#                 #Test chiusura alle 18
#             (117, timeNow.replace( day=8, month=7, hour=10, minute=0)), 
#             (117, timeNow.replace( day=8, month=7, hour=11, minute=0)), 
#             (117, timeNow.replace( day=9, month=7, hour=8, minute=5)), 
#                
#                 #Test minuti non recuperati la sera
#             (117, timeNow.replace( day=9, month=7, hour=10, minute=0)), 
#             (117, timeNow.replace( day=9, month=7, hour=11, minute=0)),
#             (117, timeNow.replace( day=9, month=7, hour=15, minute=1)),
#                
#                 #Test minuti recuperati la sera
#             (117, timeNow.replace( day=10, month=7, hour=6, minute=5)),
#             (117, timeNow.replace( day=10, month=7, hour=10, minute=0)), 
#             (117, timeNow.replace( day=10, month=7, hour=11, minute=0)),
#             (117, timeNow.replace( day=10, month=7, hour=15, minute=6)),
#                
#                 #Test entro alle 17:00 ed entro alle 17:30        a mezzogiorno e mezzo perdo la mezz'ora
#             (117, timeNow.replace( day=11, month=7, hour=6, minute=0)),
#             (117, timeNow.replace( day=11, month=7, hour=10, minute=29)),
#             (117, timeNow.replace( day=11, month=7, hour=15, minute=0)),
#             (117, timeNow.replace( day=11, month=7, hour=15, minute=30)),
# # 
#                 #Test esco 12:30 entro 13:00 e perdo la mezz'ora perche' ho un'ora di pausa pranzo
#             (117, timeNow.replace( day=12, month=7, hour=5, minute=48)),
#             (117, timeNow.replace( day=12, month=7, hour=10, minute=33)),
#             (117, timeNow.replace( day=12, month=7, hour=11, minute=0)),
#             (117, timeNow.replace( day=12, month=7, hour=15, minute=00)),
            
#                 #Test entro alle 17:30 e non esco
#             (117, timeNow.replace( day=12, month=7, hour=6, minute=0)),
#             (117, timeNow.replace( day=12, month=7, hour=10, minute=0)),
#             (117, timeNow.replace( day=12, month=7, hour=16, minute=30)),
#             (117, timeNow.replace( day=13, month=7, hour=6, minute=01)),

#                 #Test entro alle 16:30 ed esco alle 17:01 non recuperando il ritardo della mattina
#             (117, timeNow.replace( day=12, month=7, hour=6, minute=5)),
#             (117, timeNow.replace( day=12, month=7, hour=10, minute=29)),
#             (117, timeNow.replace( day=12, month=7, hour=14, minute=30)),
#             (117, timeNow.replace( day=12, month=7, hour=15, minute=01)),
