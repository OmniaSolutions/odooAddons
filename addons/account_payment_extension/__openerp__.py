...
# $Id$
# Copyright (C) 2015 Omniasolutons (www.omniasolutions.eu) All Rights Reserved
# Omniasolutions mail: info@omniasolutions.eu
#
...

{
    ...
    'version': '1.1.1',
    'author': 'Zikzakmedia SL and OmniaSolutions',
