...
class Stock_picking_ddt_pdf_report(report_sxw.rml_parse):
...
class Stock_picking_ddt_pdf(osv.AbstractModel):
    _name = 'report.stock_picking_ddt_pdf'
    _inherit = 'report.abstract_report'
    _template = 'omnia_ddt.stock_picking_ddt_pdf'
    _wrapped_report_class = Stock_picking_ddt_pdf_report
